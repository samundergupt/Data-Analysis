...
-- ---------------------------------------------------------
-- STEP 3: ASSIGNMENT SOLUTIONS
-- ---------------------------------------------------------

-- Question 1: Ranking of students based on score (highest first)
SELECT 
    name, 
    score, 
...
-- Question 2: Show each student's score and the previous student's score
SELECT 
    name, 
    score, 
...
-- Question 3: Convert names to uppercase and extract month name
SELECT 
    UPPER(name) AS student_name_upper, 
    MONTHNAME(join_date) AS join_month 
FROM Student_Performance;

-- Question 4: Show name and next student's attendance
SELECT 
    name, 
    attendance, 
...
-- Question 6: Row number based on attendance for each course
SELECT 
    name, 
    course, 
    attendance, 
...
-- Question 7: Calculate days enrolled (Assuming current date = '2025-01-01')
SELECT 
    name, 
    join_date, 
...
-- Question 10: Highest score in each course using FIRST_VALUE
SELECT 
    name, 
    course, 
    score, 
